...
import { w as resolveManifestAssetLink, s as resolveManifestCssLink, k as rootRouteId, x as getNormalizedURL, y as getOrigin, z as waitForRequest, A as bindSsrResponseToRequest, C as normalizeSsrResponse, D as attachRouterServerSsrUtils, E as _getRenderedMatches, F as defineHandlerCallback, G as createSerializationAdapter, H as createRawStreamRPCPlugin, i as invariant, g as isNotFound, I as isRedirect, J as isResolvedRedirect, K as replaceSsrResponse, L as mergeHeaders, M as isSsrResponse, N as disposeSsrResponseDetached, O as executeRewriteInput, P as stripSsrResponseBody, Q as defaultSerovalPlugins, S as makeSerovalPlugin, p as getScriptPreloadAttrs, T as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cj_21App.mjs");
