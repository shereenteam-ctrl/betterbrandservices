...
import { q as resolveManifestAssetLink, j as rootRouteId, u as getNormalizedURL, v as getOrigin, w as attachRouterServerSsrUtils, x as defineHandlerCallback, y as createSerializationAdapter, z as createRawStreamRPCPlugin, i as invariant, g as isNotFound, l as isRedirect, A as isResolvedRedirect, C as mergeHeaders, D as executeRewriteInput, E as defaultSerovalPlugins, F as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CCdUADPb.mjs");
